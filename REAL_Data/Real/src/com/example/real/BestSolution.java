package com.example.real;
	...
	public class BestSolution extends Activity {
		String s;
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.bestoutcome);
	       // adapter.clear();
	    ...
	    lstListView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent i=new Intent(BestSolution.this, Solution.class);
				startActivity(i);
	    ...
	    public void LoadSpinnerData(View v)
		{
		        ...
		        List<String> lables1 = db.getAllbest();
