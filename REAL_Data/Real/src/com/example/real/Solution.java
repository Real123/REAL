package com.example.real;
	...
	public class Solution extends Activity {
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.best_solution);
	  ...
	  img=BestSolution.id;
			...
			public void onClick(View v) 
			{
			        ...
			        try
			        {
			        	...
			        	Cursor type=db.getBest(img);
						getcount=type.getCount(); 
			    	if(getcount==0)
			    	{
			    		Toast.makeText(Solution.this, "data not fetch "+getcount+DatabaseHandler.ok1,Toast.LENGTH_LONG).show();
			    ...
			    Toast.makeText(Solution.this, "data not fetch "+e+img,Toast.LENGTH_LONG).show();  
				}
		...
		public void onBackPressed() {
			...
			//tempFile.delete();
			Intent intent = new Intent(Solution.this,BestSolution.class);
