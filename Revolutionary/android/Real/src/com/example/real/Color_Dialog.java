package com.example.real;
	...
	public class Color_Dialog {
		public interface OnColorDialogListener {
			void onCancel(Color_Dialog dialog);
			void onOk(Color_Dialog dialog, int color);
		}

		final AlertDialog dialog;
		final OnColorDialogListener listener;
		final View viewHue;
		final ColorSupport viewSatVal;
		 ...
		 */
		public Color_Dialog(final Context context, int color, OnColorDialogListener listener) {
			this.listener = listener;
			Color.colorToHSV(color, currentColorHsv);

			final View view = LayoutInflater.from(context).inflate(R.layout.ambilwarna_dialog, null);
			viewHue = view.findViewById(R.id.ambilwarna_viewHue);
			viewSatVal = (ColorSupport) view.findViewById(R.id.viewSatBri);
			viewCursor = (ImageView) view.findViewById(R.id.cursor);
			viewOldColor = view.findViewById(R.id.warnaLama);
			...
			dialog = new AlertDialog.Builder(context)
				.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
					@Override public void onClick(DialogInterface dialog, int which) {
						if (Color_Dialog.this.listener != null) {
							Color_Dialog.this.listener.onOk(Color_Dialog.this, getColor());
						}
					}
				})
				.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
					@Override public void onClick(DialogInterface dialog, int which) {
						if (Color_Dialog.this.listener != null) {
							Color_Dialog.this.listener.onCancel(Color_Dialog.this);
						}
					}
				})
