package com.example.real;
	...
	public class ColorSupport extends View {
		Paint paint;
		Shader luar;
		final float[] color = { 1.f, 1.f, 1.f };

		public ColorSupport(Context context) {
			this(context, null);
		}

		public ColorSupport(Context context, AttributeSet attrs) {
			this(context, attrs, 0);
		}

		public ColorSupport(Context context, AttributeSet attrs, int defStyle) {
